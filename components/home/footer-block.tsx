...
// Define types for FooterItem props
interface FooterItemProps {
  text: string;
  link: string;
}

// Define types for FooterBlockItem props
interface FooterBlockItemProps {
  title: string;
  items: { id: number; text: string; link: string }[];
}

// Define types for the footer block data
...
const footerBlocks: FooterBlockData[] = [
  {
    id: 1,
    title: "Links",
    items: [
  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300">
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 grid grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-16 py-20">
        ...
        <div className="space-y-6 col-span-2">
          <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">News-letter</h1>
